...
COLLECTIONS = {
    ...
    "咖啡风味化学与品质": ["咖啡", "coffee", "风味", "flavor", "aroma", "香气",
        "咖啡豆", "烘焙", "roasting", "barista", "阿拉比卡", "arabica",
        "绿原酸", "chlorogenic", "咖啡因", "caffeine", "葫芦巴碱", "trigonelline",
        "吡嗪", "pyrazine", "呋喃", "furan", "代谢组学", "metabolomics",
        "感官", "sensory", "杯测", "cupping", "食品化学", "food chemistry"],
